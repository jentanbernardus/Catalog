...
<?php $total_pages = get_comment_pages_count(); if ( $total_pages > 1 ) : ?>    
      ...
      <div class="paginated-comments-links"><?php paginate_comments_links(); ?></div>
         </div><!Ð #comments-nav-below Ð>
<?php endif; ?>    
     
    </div><!Ð #comments-list .comments Ð>
...
<?php wp_list_comments('type=pings&callback=custom_pings'); ?>
    ...
    </div><!Ð #trackbacks-list .comments Ð>  
...
<?php if ( 'open' == $post->comment_status ) : ?>
    <div id="respond" class="clearfix fade">
...
<?php else : ?>
       ...
       <p id="comment-notes"><?php _e('Your email is <em>never</em> published nor shared.', 'your-theme') ?> <?php if ($req) _e('Required fields are marked <span class="required">*</span>', 'your-theme') ?></p>
        ...
        <div class="form-input"><input id="author" name="author" type="text" value="<?php echo $comment_author ?>" size="30" maxlength="20" tabindex="3" /></div>
              </div><!Ð #form-section-author .form-section Ð>
...
<?php endif /* if ( $user_ID ) */ ?>
        ...
        <div class="form-textarea"><textarea id="comment" name="comment" cols="45" rows="8" tabindex="6"></textarea></div>
              </div><!Ð #form-section-comment .form-section Ð>
...
<?php /* Just É end everything. We're done here. Close it up. */ ?>  
      ...
      </form><!Ð #commentform Ð>          
     </div><!Ð .formcontainer Ð>
<?php endif /* if ( get_option('comment_registration') && !$user_ID ) */ ?>
    </div><!Ð #respond Ð>
<?php endif /* if ( 'open' == $post->comment_status ) */ ?>
   </section><!Ð #comments Ð>